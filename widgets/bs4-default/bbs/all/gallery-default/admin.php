<div id="mjointbox">
	...
	<form name="procform" class="" role="form">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="text" name="title" value="<?php echo $wdgvar['title']?$wdgvar['title']:'최근 갤러리'?>" class="form-control form-control-sm" placeholder="">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-3 col-form-label control-label-sm">링크연결</label>
			<div class="col-sm-8">
		...
		<div class="form-group row">
			<label class="col-sm-3 col-form-label control-label-sm">한열 항목수</label>
			<div class="col-sm-4">
		...
		<div class="form-group row">
			<label class="col-sm-3 col-form-label control-label-sm">제목자르기</label>
			<div class="col-sm-8">
		...
		<div class="form-group row">
			<label class="col-sm-3 col-form-label">보기형식</label>
			<div class="col-sm-8">
