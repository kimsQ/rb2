...
$d['layout']['widget'] = array (
	...
	'post' => array(
		...
		array(
			...
			array('rc-default/post/all/swipe-multi','최근 포스트 스와이프 멀티형'),

			array('rc-default/post/best/list-default','인기 포스트 리스트형'),
			array('rc-default/post/best/medialist-default','인기 포스트 미디어 리스트형'),
			array('rc-default/post/best/gallery-default','인기 포스트 갤러리형'),
			array('rc-default/post/best/gallery-grid','인기 포스트 포토 그리드형'),
			array('rc-default/post/best/swipe-default','인기 포스트 스와이프 기본형'),
			array('rc-default/post/best/swipe-multi','인기 포스트 스와이프 멀티형'),
